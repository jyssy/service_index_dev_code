...
CREATE TABLE serviceindex.host (
    ...
    ip_addresses character varying(128) NOT NULL,
...
COPY serviceindex.host (id, hostname, ip_addresses, qualys, nagios, label, note, host_last_verified, availability_id, location_id, poc_backup_id, poc_primary_id, service_id, support_id, sys_admin_id, syslog_relp_10515, syslog_standard_10514) FROM stdin;
